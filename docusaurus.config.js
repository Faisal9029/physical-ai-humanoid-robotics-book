// @ts-check
// `@type` JSDoc annotations allow IDEs and type checkers to scan your code for errors
//  and provide smart suggestions.
...
const config = {
  ...
  i18n: {
    ...
    localeConfigs: {
      ...
      ur: {
        label: 'اردو',
        direction: 'rtl', // Urdu is written right-to-left
      },
    },
  },
